...
import benchmark from './dapper-vs-ef-core-performance.PNG'
...
Let's see what this benchmark has to say:

<a href="https://exceptionnotfound.net/dapper-vs-entity-framework-core-query-performance-benchmarking-2019/">
