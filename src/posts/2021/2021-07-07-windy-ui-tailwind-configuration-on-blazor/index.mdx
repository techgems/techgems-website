...
You'll also need a base CSS file. This file should be located in a separate folder. For the purposes of this walkthrough, we'll be calling it "Styles".
...
Finally you'll need a package.json file for this in the same folder with the installation for both Tailwind, PostCSS and the forms plugin.
