  ...
  return (
    <BlogContainer>
      ...
      <section className="max-w-2xl mx-auto mt-12">
        ...
        <p className="text-gray-700 mx-auto text-base font-body font-light leading-relaxed mb-6">
        ...
        <ul className="mb-6 text-gray-700 text-base font-body font-light leading-relaxed list-disc list-inside ml-6">
        ...
        <p className="text-gray-700 mx-auto text-base font-body font-light leading-relaxed mb-6">
          ...
          me through my email:{" "}
          <a href="mailto:cjimenezber@gmail.com">cjimenezber@gmail.com</a>, you
          can also check my <a href="https://github.com/techgems">Github</a> and{" "}
          <a href="https://www.linkedin.com/in/carlos-jimenez-61a926b7/">
            Linked In
          </a>
        </p>
      </section>
